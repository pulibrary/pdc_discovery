...
namespace :index do
  ...
  task research_data: :environment do
    ...
    Rails.logger.error("Indexing: Error indexing research data. #{e.message}")
    Honeybadger.notify("Indexing: Error indexing research data. #{e.message}")
  end
