...
RSpec.describe DateNormalizer do
  ...
  describe "#strict_dates" do
    it "sorts dates ascending" do
      expect(described_class.strict_dates(["2021-12-14", nil, "1999-12-31"])).to eq %w[1999-12-31 2021-12-14]
    end
  end
  ...
  describe "#strict_date" do
    ...
    it "detects bad dates" do
      expect(described_class.strict_date("2021-14-14")).to be_nil
      expect(described_class.strict_date("202")).to be_nil
      expect(described_class.strict_date("blah")).to be_nil
      expect(described_class.strict_date("")).to be_nil
      expect(described_class.strict_date(nil)).to be_nil
    end
  end
end
