...
It provides a feed of the full JSON blob from PDC Describe for every object tagged as belonging to the Princeton Plasma Physics Laborary group, sorted by most recently updated first. This is so PPPL can harvest data set to report to OSTI.
